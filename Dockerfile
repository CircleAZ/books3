...
# ENV NEW_RELIC_CONFIG_FILE=newrelic.ini  # Disabled for performance on free tier
...
CMD ["gunicorn", "azbooks.wsgi:application", "--bind", "0.0.0.0:8000", "--workers", "2", "--threads", "2", "--worker-class", "gthread", "--timeout", "120"]
