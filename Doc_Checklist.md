...
- **File Count**: 9 files
- **Status**: - [x] **Complete** (`docs/architecture/frontend/FE-25_store_settings_system_info_tax_configuration.md`)
- **Member Files**:
...
- **File Count**: 10 files
- **Status**: - [x] **Complete** (`docs/architecture/frontend/FE-26_rbac_administration_data_management.md`)
- **Member Files**:
...
- **File Count**: 9 files
- **Status**: - [x] **Complete** (`docs/architecture/frontend/FE-27_academic_customer_hierarchy_settings.md`)
- **Member Files**:
...
| `FE-25` | Store Settings, System Info & Tax Configuration | Settings Domain | 9 | `docs/architecture/frontend/FE-25_store_settings_system_info_tax_configuration.md` | - [x] Complete |
| `FE-26` | RBAC Administration & Data Management | Settings Domain | 10 | `docs/architecture/frontend/FE-26_rbac_administration_data_management.md` | - [x] Complete |
| `FE-27` | Academic & Customer Hierarchy Settings | Settings Domain | 9 | `docs/architecture/frontend/FE-27_academic_customer_hierarchy_settings.md` | - [x] Complete |
