# Generated manually to fix duplicate orders batch:
# 1093, 1098, 1100, 1106, 1112, 1114
#
...
DUPLICATES = [
    (1093, 1094),  # Khushi Sunilbhai Tandel
    (1098, 1097),  # Om Nitinbhai Tandel
    (1100, 1099),  # Heet Jigarbhai Tandel
    (1106, 1107),  # Hevin Bhaveshbhai Tandel
    (1112, 1111),  # Hinal/Krish Bhavneshbhai Tandel
    (1114, 1113),  # Drashti Jitendrabhai Tandel
]
