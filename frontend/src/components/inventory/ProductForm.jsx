    ...
    useEffect(() => {
        if (initialData) {
            setFormData({
                ...
                cost_price: initialData.cost_price ? Number(initialData.cost_price).toFixed(2) : '',
                selling_price: initialData.selling_price ? Number(initialData.selling_price).toFixed(2) : '',
